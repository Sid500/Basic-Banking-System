        ...
        <br>
            <div class="row">
                <div class="col">
                    ...
                    <table class="table table-hover table-sm table-striped table-condensed table-bordered table-info" style="border-color:white;">
                ...
                ?>
                    <tr style="color : white;">
                        ...
                        <td class="py-2" style="color : black;"><?php echo $rows['gender']?></td>
