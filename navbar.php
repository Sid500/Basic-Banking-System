<!-- navbar --> 
      ...
      <a class="navbar-brand" href="index.php" style="color : #495057;"><img src="img/bnklg.png" alt="Logo" width="26" style="margin-bottom:4px;"> <b> Bank of Asia</b></a>
      ...
      <div class="collapse navbar-collapse" id="collapsibleNavbar">
            <ul class="navbar-nav ml-auto">
              ...
              <li class="nav-item">
                <a class="nav-link" href="all_customers.php" style="color : #495057;"><b>Customers</b></a>
              </li>
              <li class="nav-item">
